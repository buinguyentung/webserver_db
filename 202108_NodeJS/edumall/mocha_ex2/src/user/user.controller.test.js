...
/** 
 * In the first three it blocks, we are testing that a user will not be created 
 * when one or both of the required parameters (email and name) are not provided. 
 ...
 * Notice that we also had to use a spy in place UserRepository 
